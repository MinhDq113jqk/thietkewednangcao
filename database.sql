...
VALUES
    ...
    ('f1000000-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000003', 'Nón bài thơ xứ Huế khâu tay', '/images/non-hue.jpg', 150000, 1)
ON CONFLICT (id) DO NOTHING;
